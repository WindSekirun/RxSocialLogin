...
open class BaseSocialObservable<T : BaseSocialLogin>(private val login: T) : Observable<LoginResultItem>() {
    ...
    private class Listener<out T : BaseSocialLogin>(val login: T, val observer: Observer<in LoginResultItem>?) :
